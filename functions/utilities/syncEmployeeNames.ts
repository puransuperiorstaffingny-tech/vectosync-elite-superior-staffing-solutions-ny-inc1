...
Deno.serve(async (req) => {
  try {
    ...
    if (staleEntries.length > 0) {
      ...
      console.log(`Updated ${staleEntries.length} TimeEntry records`);
    }
    ...
    if (staleItems.length > 0) {
      ...
      console.log(`Updated ${staleItems.length} PayrollItem records`);
    }
    ...
    if (stalePayouts.length > 0) {
      ...
      console.log(`Updated ${stalePayouts.length} Payout records`);
    }
